<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="采集员工号" prop="caijiyuangonghao">
          <el-input v-model="ruleForm.caijiyuangonghao" 
              placeholder="采集员工号" clearable  :readonly="ro.caijiyuangonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="采集员工号" prop="caijiyuangonghao">
              <el-input v-model="ruleForm.caijiyuangonghao" 
                placeholder="采集员工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="采集员姓名" prop="caijiyuanxingming">
          <el-input v-model="ruleForm.caijiyuanxingming" 
              placeholder="采集员姓名" clearable  :readonly="ro.caijiyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="采集员姓名" prop="caijiyuanxingming">
              <el-input v-model="ruleForm.caijiyuanxingming" 
                placeholder="采集员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="详细行程" prop="xiangxixingcheng">
          <el-input v-model="ruleForm.xiangxixingcheng" 
              placeholder="详细行程" clearable  :readonly="ro.xiangxixingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="详细行程" prop="xiangxixingcheng">
              <el-input v-model="ruleForm.xiangxixingcheng" 
                placeholder="详细行程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分析员账号" prop="fenxiyuanzhanghao">
          <el-input v-model="ruleForm.fenxiyuanzhanghao" 
              placeholder="分析员账号" clearable  :readonly="ro.fenxiyuanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分析员账号" prop="fenxiyuanzhanghao">
              <el-input v-model="ruleForm.fenxiyuanzhanghao" 
                placeholder="分析员账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分析员姓名" prop="fenxiyuanxingming">
          <el-input v-model="ruleForm.fenxiyuanxingming" 
              placeholder="分析员姓名" clearable  :readonly="ro.fenxiyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分析员姓名" prop="fenxiyuanxingming">
              <el-input v-model="ruleForm.fenxiyuanxingming" 
                placeholder="分析员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="风险评估" prop="fengxianpinggu">
          <el-select :disabled="ro.fengxianpinggu" v-model="ruleForm.fengxianpinggu" placeholder="请选择风险评估">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="风险评估" prop="fengxianpinggu">
	      <el-input v-model="ruleForm.fengxianpinggu"
                placeholder="风险评估" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pinggushijian" label="评估时间" prop="pinggushijian">
              <el-input v-model="ruleForm.pinggushijian" 
                placeholder="评估时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="评估结果" prop="pinggujieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="评估结果"
                  v-model="ruleForm.pinggujieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pinggujieguo" label="评估结果" prop="pinggujieguo">
                    <span>{{ruleForm.pinggujieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	caijiyuangonghao : false,
	caijiyuanxingming : false,
	zhanghao : false,
	xingming : false,
	shenfenzheng : false,
	shouji : false,
	xiangxixingcheng : false,
	hesuanma : false,
	xingchengma : false,
	fenxiyuanzhanghao : false,
	fenxiyuanxingming : false,
	fengxianpinggu : false,
	pinggujieguo : false,
	pinggushijian : false,
	beizhu : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='caijiyuangonghao'){
            this.ruleForm.caijiyuangonghao = obj[o];
	    this.ro.caijiyuangonghao = true;
            continue;
          }
          if(o=='caijiyuanxingming'){
            this.ruleForm.caijiyuanxingming = obj[o];
	    this.ro.caijiyuanxingming = true;
            continue;
          }
          if(o=='zhanghao'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='xiangxixingcheng'){
            this.ruleForm.xiangxixingcheng = obj[o];
	    this.ro.xiangxixingcheng = true;
            continue;
          }
          if(o=='hesuanma'){
	    ...
	    this.ro.xingchengma = true;
          ...
          if(o=='fenxiyuanzhanghao'){
            this.ruleForm.fenxiyuanzhanghao = obj[o];
	    this.ro.fenxiyuanzhanghao = true;
            continue;
          }
          if(o=='fenxiyuanxingming'){
            this.ruleForm.fenxiyuanxingming = obj[o];
	    this.ro.fenxiyuanxingming = true;
            continue;
          }
          if(o=='fengxianpinggu'){
            this.ruleForm.fengxianpinggu = obj[o];
	    this.ro.fengxianpinggu = true;
            continue;
          }
          if(o=='pinggujieguo'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.fenxiyuanzhanghao!=''&&json.fenxiyuanzhanghao){
                this.ruleForm.fenxiyuanzhanghao = json.fenxiyuanzhanghao
	    		this.ro.fenxiyuanzhanghao = true;
		}
		if(json.fenxiyuanxingming!=''&&json.fenxiyuanxingming){
                this.ruleForm.fenxiyuanxingming = json.fenxiyuanxingming
	    		this.ro.fenxiyuanxingming = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `caijifenxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.caijifenxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
