    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="行程登记" prop="xingchengdengji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="行程登记"
                  v-model="ruleForm.xingchengdengji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingchengdengji" label="行程登记" prop="xingchengdengji">
                    <span>{{ruleForm.xingchengdengji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
