<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="采集日期" prop="caijiriqi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.caijiriqi" 
                type="datetime"
                :readonly="ro.caijiriqi"
                placeholder="采集日期">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.caijiriqi" label="采集日期" prop="caijiriqi">
              <el-input v-model="ruleForm.caijiriqi" 
                placeholder="采集日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="用户行程" prop="yonghuxingcheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="用户行程"
                  v-model="ruleForm.yonghuxingcheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yonghuxingcheng" label="用户行程" prop="yonghuxingcheng">
                    <span>{{ruleForm.yonghuxingcheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详细行程" prop="xiangxixingcheng">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiangxixingcheng" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangxixingcheng" label="详细行程" prop="xiangxixingcheng">
                    <span v-html="ruleForm.xiangxixingcheng"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.caijiriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangxixingcheng = true;
          ...
          if(o=='yonghuxingcheng'){
            this.ruleForm.yonghuxingcheng = obj[o];
	    this.ro.yonghuxingcheng = true;
            continue;
          }
          if(o=='hesuanma'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='caijiriqi'){
            this.ruleForm.caijiriqi = obj[o];
	    this.ro.caijiriqi = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.caijiyuangonghao!=''&&json.caijiyuangonghao){
                this.ruleForm.caijiyuangonghao = json.caijiyuangonghao
	    		this.ro.caijiyuangonghao = true;
		}
		if(json.caijiyuanxingming!=''&&json.caijiyuanxingming){
                this.ruleForm.caijiyuanxingming = json.caijiyuanxingming
	    		this.ro.caijiyuanxingming = true;
		}
        } else {
	...
	this.ruleForm.xiangxixingcheng = this.ruleForm.xiangxixingcheng.replace(reg,'../../../springbootxz02k/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `caijishuju/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.caijishujuCrossAddOrUpdateFlag = false;
						 this.parent.search();
