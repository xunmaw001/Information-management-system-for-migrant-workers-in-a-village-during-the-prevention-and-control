<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="外出地" prop="waichudi">
          <el-input v-model="ruleForm.waichudi" 
              placeholder="外出地" clearable  :readonly="ro.waichudi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="外出地" prop="waichudi">
              <el-input v-model="ruleForm.waichudi" 
                placeholder="外出地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="行程登记" prop="xingchengdengji">
          <el-input v-model="ruleForm.xingchengdengji" 
              placeholder="行程登记" clearable  :readonly="ro.xingchengdengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="行程登记" prop="xingchengdengji">
              <el-input v-model="ruleForm.xingchengdengji" 
                placeholder="行程登记" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.hesuanma = true;
          ...
          if(o=='waichudi'){
            this.ruleForm.waichudi = obj[o];
	    this.ro.waichudi = true;
            continue;
          }
          if(o=='xingchengdengji'){
            this.ruleForm.xingchengdengji = obj[o];
	    this.ro.xingchengdengji = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xingchengfenxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xingchengfenxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
