...
public class CaijifenxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public CaijifenxiEntity() {
		
	}
	
	public CaijifenxiEntity(T t) {
		try {
	...
	private String caijiyuangonghao;
	 ...
	 * 设置：采集员工号
	 */
	public void setCaijiyuangonghao(String caijiyuangonghao) {
		this.caijiyuangonghao = caijiyuangonghao;
	}
	/**
	 * 获取：采集员工号
	 */
	public String getCaijiyuangonghao() {
		return caijiyuangonghao;
	}
	/**
	 * 设置：采集员姓名
	 */
